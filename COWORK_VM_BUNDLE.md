# Cowork VM Bundle Reference - v1.14271.0
...
## Current Config (v1.14271.0)

> **v1.14271.0:** VM bundle is **unchanged** from v1.12603.0 - same bundle SHA `6d1538ba6fecc4e5c5583993c4b30bb1875f0f5a`, identical rootfs/vmlinuz/initrd checksums and `vm-bundle-config.json`. Only the Claude Desktop wrapper was rebuilt.
...
|----------------------|--------------|-----------------|
| 1.14271.0 | 6d1538ba6fecc4e5c5583993c4b30bb1875f0f5a | No VM bundle changes; identical config, images, and all file checksums to v1.12603.0 |
